...
describe("Sign up form", () => {
  ...
  test("Preferences input is changed", () => {
    const preferencesInput = screen.getByTestId(/preference/i);
    preferencesInput.focus();
    expect(preferencesInput).toHaveFocus();
    expect(preferencesInput).toHaveValue(""); // before
    fireEvent.change(document.activeElement, { target: { value: "Romance" } });
