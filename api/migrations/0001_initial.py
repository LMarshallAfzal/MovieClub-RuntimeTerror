# Generated by Django 4.0.1 on 2022-03-09 18:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('movieID', models.PositiveIntegerField(default=0, unique=True)),
        ...
        migrations.AddField(
            model_name='movie',
            name='watched',
            field=models.ManyToManyField(related_name='Watched', through='api.Viewer', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Membership',
            fields=[
