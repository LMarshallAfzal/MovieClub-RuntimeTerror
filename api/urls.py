...
urlpatterns = [
    ...
    path("favourite_movies/<int:user_id>/",views.get_favourite_movies, name = "get_favourite_movies"),
    ...
    path("get_user_joined_clubs/<int:user_id>/", views.get_clubs_user_is_member_of, name = "get_clubs_user_is_member_of"),
    path("user_memberships/<int:user_id>/", views.get_memberships_of_user, name="get_memberships_of_user"),
