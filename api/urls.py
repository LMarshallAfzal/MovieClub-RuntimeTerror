...
urlpatterns = [
    ...
    path("memberships/<int:user_id>/", views.get_clubs_user_is_member_of, name = "get_clubs_user_is_member_of"),
    path("mem/<int:user_id>/", views.get_memberships_of_user, name="mem"),
