...
class AddRatingSerializer(serializers.ModelSerializer):
    ...
    score = serializers.FloatField(required = True,validators=[MinValueValidator(0.0), MaxValueValidator(5.0)])
...
class ChangeRatingSerializer(serializers.ModelSerializer):
    score = serializers.FloatField(required = True,validators=[MinValueValidator(1.0), MaxValueValidator(5.0)])
    class Meta:
        model = Rating
        fields = ['score']
